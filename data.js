    ...
    classes: [
        {
            ...
            dengarModifiers: [
                "Periodically gets a lingering potion which gives haste I, speed III, slowness IV and mining fatigue I",
            ],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: [
                "Spikey shield with mending, projectile protection and 30 % knockback resistance (piece of netherite)",
            ],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: ["Periodically gets single use eggs"],
            positiveModifiers: [
                "Gain 5 placeable turtle eggs that give Slowness III and explode when stepped on",
                "Regain eggs when triggered",
            ],
            negativeModifiers: [
                "Eggs can be defused by shears or silk touch",
                "Dying destroys all their eggs",
        ...
        },
        {
            ...
            dengarModifiers: [
                "Gives resistance to all allies above 18 health within 8 blocks",
            ],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: ["Gets free scaffolding and steak"],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: ["Gets haste II + speed I when above 10HP"],
            positiveModifiers: ["Increased attack speed with swords (+50%)"],
        ...
        },
        {
            ...
            dengarModifiers: ["Gets protection II shield with mending"],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: [
                ...
                "When hold flint and steel, forces all tnt's fuse within 10 blocks on 10 seconds",
            ],
            positiveModifiers: [
        ...
        },
        {
            ...
            negativeModifiers: ["Decreased maximum health points (-2)"],
        },
        {
            name: "Looter",
            color: "9FEF00",
        ...
        },
        {
            ...
            dengarModifiers: ["Removes all slowness from alies nearby"],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: [
                "Resistance I when near full hp allie",
        ...
        },
        {
            ...
            dengarModifiers: [
                "Gets soup (big saturation, many debuff, probably still OP)",
            ],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: [
                "All players nearby who are withered will also be slowed (iceman slowness (slowness IV I think))",
            ],
            positiveModifiers: [
        ...
        },
        {
            ...
            dengarModifiers: [
                "Sets spider friends periodically and can place down, can also overwrite spawners with it",
            ],
            positiveModifiers: [
                "Increased movement speed and Regeneration in cobwebs",
                "Can place cobwebs up to 8 blocks away",
                "Spiders won't attack unless provoked",
            ],
            negativeModifiers: [
                "Decreased movement speed (-50%) and Hunger IV when out of webs",
